    ...
    return TFormContainer(
      ...
      child: Column(
        ...
        children: [
          ...
          TTextWithIcon(text: 'Selected Colors', icon: Iconsax.color_swatch),
          SizedBox(height: TSizes().spaceBtwItems),

          Obx(() => controller.selectedColors.isEmpty
              ? Text('Your selected colors will be displayed here.', style: Theme.of(context).textTheme.bodyMedium)
              : SizedBox.shrink()),
          ...
          Obx(() => controller.selectedColors.isNotEmpty
              ? Text('Long press to delete the color added from the list.', style: Theme.of(context).textTheme.labelMedium)
              : SizedBox.shrink()),
        ],
      ),
    );
