...
class CategoryTable extends StatelessWidget {
          ...
          () {
            return TDataTable(
              ...
              rows: controller.filteredItems.where((item) => item.parentId.isNotEmpty).toList().asMap().entries.map((entry) {
                ...
                return buildDataRow(controller, index, category, context);
              }).toList(),
            );
          },
        ),
  ...
  DataRow buildDataRow(CategoryController controller, int index, CategoryModel item, BuildContext context) {
