          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                /// Heading
                const TTextWithIcon(text: 'Update Banner', icon: Iconsax.activity),
                ...
                TextFormField(
                  ...
                  validator: (value) => TValidator.validateEmptyText('Banner Title', value),
                  decoration: const InputDecoration(labelText: 'Banner Title', prefixIcon: Icon(Iconsax.code)),
                ),
                ...
                Text(
                  'Note: If Start & End Dates are empty then banner will stay active forever, until manually mark as inActive',
                  ...
                  child: Column(
                    children: [
                      TDropdown<BannerTargetType>(
                        labelText: 'Banner Target Type',
                        hintText: 'Select Banner Target Type',
                        ...
                        if (controller.bannerTargetType.value == BannerTargetType.productScreen) {
                          ...
                          return TextFormField(
                            ...
                            decoration: const InputDecoration(
                                labelText: 'Custom URL', prefixIcon: Icon(Iconsax.add), hintText: 'Share the URL you want to use.'),
                          );
                        } else {
                    ...
                    child: controller.isLoading.value
                        ...
                        : SizedBox(
                            ...
                            child: ElevatedButton(
                                onPressed: () => controller.updateBanner(controller.banner.value), child: const Text('Update')),
                          ),
                  ),
                ),
                SizedBox(height: TSizes().spaceBtwInputFields * 2),
