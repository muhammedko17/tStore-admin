  ...
  Widget build(BuildContext context) {
    ...
    return TContainer(
      ...
      child: Column(
        ...
        children: [
          // Retailer label
          Text('Select Brand', style: Theme.of(context).textTheme.titleLarge),
          SizedBox(height: TSizes().spaceBtwItems / 2),

          // TextField for input
          Text('Add Search Keyword and Press Enter to Search', style: Theme.of(context).textTheme.labelMedium),
          ...
          TextFormField(
            ...
            decoration: const InputDecoration(labelText: 'Search Brands', prefixIcon: Icon(Icons.search)),
          ),
          ...
          Obx(() {
            if (controller.selectedBrand.value.id.isNotEmpty) {
              return Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  TTextWithIcon(text: 'Selected Item', icon: Iconsax.tick_circle),
                  SizedBox(height: TSizes().sm),
                  TContainer(
