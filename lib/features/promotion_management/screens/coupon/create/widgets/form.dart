      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            ...
            const TTextWithIcon(text: 'Create new Coupon', icon: Iconsax.activity),
            SizedBox(height: TSizes().spaceBtwSections),

            // Text Field
            TextFormField(
              controller: controller.code,
              validator: (value) => TValidator.validateEmptyText('Coupon Code', value),
              decoration: const InputDecoration(labelText: 'Coupon Code', prefixIcon: Icon(Iconsax.code)),
            ),
            ...
            DropdownButtonFormField<DiscountType>(
              ...
              decoration: const InputDecoration(labelText: 'Discount Type', prefixIcon: Icon(Iconsax.discount_shape)),
            ...
            TextFormField(
              ...
              validator: (value) => TValidator.validateEmptyText('Discount Value', value),
              decoration: const InputDecoration(labelText: 'Discount Value', prefixIcon: Icon(Iconsax.add),
                  hintText: 'Discount in terms of Number, either percentage or Flat Amount'),
            ),
            SizedBox(height: TSizes().spaceBtwInputFields),
            ...
            TextFormField(
              ...
              decoration: const InputDecoration(labelText: 'Description', prefixIcon: Icon(Iconsax.text)),
            ),
            SizedBox(height: TSizes().spaceBtwInputFields),
            ...
            TextFormField(
              ...
              decoration: const InputDecoration(
                ...
                hintText: 'No of times, this coupon can be used.',
              ),
            ),
            SizedBox(height: TSizes().spaceBtwInputFields),
              ...
              children: [
                Expanded(
                  child: TextFormField(
                    ...
                    decoration: const InputDecoration(labelText: 'Start Date', prefixIcon: Icon(Iconsax.calendar)),
                  ),
                ),
                ...
                Expanded(
                  child: TextFormField(
                    ...
                    decoration: const InputDecoration(labelText: 'End Date', prefixIcon: Icon(Iconsax.calendar)),
                  ),
                ),
              ],
            ),
            ...
            Text(
              'Note: If Start & End Dates are empty then coupon will stay active forever, until manually mark as inActive',
              style: Theme
                  .of(context)
                  .textTheme
                  .labelMedium,
            ...
            Obx(
                  ...
                  AnimatedSwitcher(
                    ...
                    child: controller.isLoading.value
                      ...
                      child: ElevatedButton(onPressed: () => controller.createCoupon(), child: const Text('Create')),
                    ),
                  ),
            ),
            SizedBox(height: TSizes().spaceBtwInputFields * 2),
