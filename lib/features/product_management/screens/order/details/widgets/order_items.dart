  ...
  Widget build(BuildContext context) {
    ...
    return TContainer(
      ...
      child: Column(
        ...
        children: [
          const TTextWithIcon(text: 'Order Items', icon: Iconsax.receipt_item),
          SizedBox(height: TSizes().spaceBtwSections),

          // Items
          Row(
            children: [
              Expanded(child: Text('Items', style: Theme.of(context).textTheme.titleSmall!.apply(letterSpacingDelta: 1.2))),
              if (TDeviceUtils.isDesktopScreen(context))
                SizedBox(width: 100, child: Text('Price', style: Theme.of(context).textTheme.titleSmall!.apply(letterSpacingDelta: 1.2))),
              if (TDeviceUtils.isDesktopScreen(context))
                SizedBox(width: 70, child: Text('Qty', style: Theme.of(context).textTheme.titleSmall!.apply(letterSpacingDelta: 1.2))),
              SizedBox(
                width: TDeviceUtils.isDesktopScreen(context) ? 100 : null,
                child: Text('Total', style: Theme.of(context).textTheme.titleSmall!.apply(letterSpacingDelta: 1.2)),
              ),
            ],
          ),
          SizedBox(height: TSizes().spaceBtwSections),
                  ...
                  Row(
                    ...
                    children: [
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('Coupon Discount', style: Theme.of(context).textTheme.titleLarge),
