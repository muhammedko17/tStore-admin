    ...
    return TContainer(
      ...
      child: Obx(
        () => Column(
          ...
          children: [
            TTextWithIcon(text: 'Order Transaction (${controller.order.value.paymentMethodType.name.toUpperCase()})', icon: Iconsax.transaction_minus),
                  ...
                  if (controller.order.value.paymentMethodId != null)
                    Expanded(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('Payment Method ID', style: Theme.of(context).textTheme.labelMedium),
                  ...
                  if (controller.order.value.paymentIntentId != null)
                    Expanded(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('Payment Intent ID', style: Theme.of(context).textTheme.labelMedium),
                          Obx(() => Text(
