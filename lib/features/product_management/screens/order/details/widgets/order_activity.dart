  ...
  Widget build(BuildContext context) {
    ...
    return TContainer(
      child: Column(
        ...
        children: [
          const TTextWithIcon(text: 'Order Activity', icon: Iconsax.activity),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: TSizes().spaceBtwItems),
                            Text('Activity Performed by ${activity.performedBy}, on ${activity.formattedDate}.',
                                maxLines: 3, style: Theme.of(context).textTheme.labelMedium)
                          ],
                        ),
                      ),
                    ],
