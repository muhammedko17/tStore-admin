...
class ProductTable extends StatelessWidget {
          ...
          () {
            return TDataTable(
              ...
              columns: [
                ...
                const DataColumn2(label: Text('Brand'), size: ColumnSize.S),
                const DataColumn2(label: Text('Type'), size: ColumnSize.S),
                const DataColumn2(label: Text('Stock'), size: ColumnSize.S),
                const DataColumn2(label: Text('Visibility'), size: ColumnSize.S),
  ...
  DataRow buildDataRow(ProductController controller, int index, ProductModel item, BuildContext context) {
    return DataRow(
