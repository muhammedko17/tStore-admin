  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        const TTextWithIcon(text: 'Product Attributes', icon: Iconsax.layer),
    ...
    return Obx(() {
      ...
      if (allActiveAttributes.isEmpty) {
        return ListTile(
          ...
          title: const Text('No Attributes Found!'),
          subtitle: const Text('Do you want to add attributes? Click here.'),
        );
      }
      ...
      return DropdownButtonFormField<AttributeModel>(
        decoration: const InputDecoration(labelText: 'Select Attribute', border: OutlineInputBorder()),
      ...
      if (attributeValues.isNotEmpty) {
        return TContainer(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const Text('Choose Attribute Values'),
