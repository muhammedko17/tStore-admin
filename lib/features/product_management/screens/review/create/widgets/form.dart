      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            ...
            const TTextWithIcon(text: 'Create new Review', icon: Iconsax.activity),
            ...
            Text('Choose your Rating', style: Theme.of(context).textTheme.titleMedium),
            Obx(
              () => RatingBar.builder(
                minRating: 1,
                itemCount: 5,
            ...
            SizedBox(
              ...
              child: TextFormField(
                ...
                decoration: const InputDecoration(labelText: 'Review', hintText: 'Add your review here...', alignLabelWithHint: true),
              ),
            ),
            SizedBox(height: TSizes().spaceBtwInputFields),
              ...
              () => AnimatedSwitcher(
                ...
                child: controller.isLoading.value
                    ...
                    : SizedBox(
                        ...
                        child: ElevatedButton(onPressed: () => controller.createReview(), child: const Text('Create')),
                      ),
              ),
            ),
            SizedBox(height: TSizes().spaceBtwInputFields * 2),
