        ...
        children: [
          ...
          TContainer(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('Search Products', style: Theme.of(context).textTheme.bodyLarge),
                ...
                Obx(
                  () => productController.searchLoader.value
                      ...
                      : TextFormField(
                          ...
                          decoration: InputDecoration(labelText: 'Search Products', prefixIcon: Icon(Iconsax.filter_search)),
                          onFieldSubmitted:
                ...
                Text(
                  'Search products using their real name as stored in database or search using tags assigned to those products.\nHit Enter to search.',
                    ...
                    children: [
                      if (productController.searchResult.isNotEmpty)
                        Row(
                          ...
                          children: [
                            Text('Results', style: Theme.of(context).textTheme.bodyLarge),
                            TextButton(onPressed: () => productController.searchResult.value = [], child: Text('Clear')),
                          ],
                        ),
                      ListView.separated(
                        shrinkWrap: true,
                            ...
                            return InkWell(
                              ...
                              child: TContainer(
                                ...
                                child: ListTile(
                                  ...
                                  subtitle: alreadyReviewed ? Text('This product is already reviewed by you.') : null,
