        ...
        Obx(
          () {
            return TDataTable(
              ...
              columns: [
                const DataColumn2(label: Text('Product'), size: ColumnSize.M),
                DataColumn2(label: const Text('Review'), onSort: (index, asc) => controller.sortByName(index, asc), size: ColumnSize.L),
                const DataColumn2(label: Text('Rating'), size: ColumnSize.S),
                const DataColumn2(label: Text('User'), size: ColumnSize.M),
