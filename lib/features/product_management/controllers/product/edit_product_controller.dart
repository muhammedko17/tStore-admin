  ...
  Future<void> updateProduct() async {
    try {
      ...
      if (productType.value == ProductType.simple &&
        ...
        throw 'Sale Price cannot be greater then Price.';
      }
      ...
      if (productType.value == ProductType.variable && ProductVariationController.instance.productVariations.isEmpty) {
        throw 'No variations found. Create some or change the Product Type.';
      }
      if (productType.value == ProductType.variable) {
        ...
        if (priceValidationCheckFailed) {
          throw 'Variation Discounted Price cannot be equal or greater then Price. Fix that and submit again.';
        }
        ...
        child: AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              buildCheckbox('Thumbnail Image', true),
              buildCheckbox('Additional Images', true),
              buildCheckbox('Product Data, Attributes & Variations', true),
              buildCheckbox('Product Categories', true),
              SizedBox(height: TSizes().spaceBtwItems),
