                ...
                children: [
                  ...
                  if (controller.allImagesFetched[controller.selectedPath.value]!.value)
                    Row(
                      ...
                      children: [
                        Text('You are viewing all the Images of ${controller.selectedPath.value.name.capitalize}'),
                      ],
                    )
                  else
                    ...
                    Row(
                      ...
                      children: [
                        ElevatedButton.icon(
                          ...
                          label: controller.loading.value ? const Text('Loading...') : const Text('Load More'),
    ...
    return Padding(
      ...
      child: TAnimationLoader(
        ...
        message: Text((controller.selectedPath.value == MediaCategory.none)
            ...
            : 'There are no Images found in this folder.'),
