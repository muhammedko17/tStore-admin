          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Expanded(
                      child: TTextWithIcon(icon: Iconsax.image, text: 'Image Name:', textStyle: Theme.of(context).textTheme.bodySmall)),
              ...
              if (image.sizeBytes != null && image.sizeBytes! > 0)
                Row(
                  children: [
                    Expanded(
                        child: TTextWithIcon(icon: Iconsax.size, text: 'Image Size:', textStyle: Theme.of(context).textTheme.bodySmall)),
                    Expanded(
                        flex: 3,
              ...
              if (image.contentType != null && image.contentType!.isNotEmpty)
                Row(
                  children: [
                    Expanded(
                        child:
                            TTextWithIcon(icon: Iconsax.activity, text: 'Image Type:', textStyle: Theme.of(context).textTheme.bodySmall)),
              ...
              Row(
                children: [
                  Expanded(
                      child: TTextWithIcon(icon: Iconsax.clock, text: 'Date Created:', textStyle: Theme.of(context).textTheme.bodySmall)),
              ...
              Row(
                children: [
                  Expanded(child: TTextWithIcon(icon: Iconsax.link, text: 'Image URL:', textStyle: Theme.of(context).textTheme.bodySmall)),
                  Expanded(
                    flex: 3,
                    child: Row(
                      children: [
                        ...
                        TIcon(
                          ...
                          onPressed: () {
                            FlutterClipboard.copy(image.url)
                                .then((value) => TNotificationOverlay.success(context: context, title: 'URL copied'));
                          },
                          icon: Iconsax.copy,
                        ),
                      ],
